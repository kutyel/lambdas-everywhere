...
<Code
  ...
  steps={[
    ...
    { lines: [3], notes: 'import the important stuff 😎' },
    { lines: [8, 9], notes: "Let's remove those magic strings 😉" },
    { lines: [2, 11], notes: 'This is just because dates freak me out 📅' },
    { tokens: { 13: [1,2,3,4,5,6], 17: [1] } , notes: '(re)compose ALL THE THINGS! 🎸' },
    ...
    { lines: [20], notes: 'Destructure all the things... 📦' },
    { range: [22,27] },
    { range: [28,33] },
    { range: [34,42] },
    { lines: [41], notes: 'That. Is. It! 🎉' },
  ]}
/>
...
<BackgroundImage src="https://media.giphy.com/media/XyLwEmBGqxkti/giphy.gif" />
...
![happy-cat](https://i.imgflip.com/17fgma.jpg)
