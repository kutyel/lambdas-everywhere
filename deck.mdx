...
<Code
  ...
  steps={[
    ...
    { range: [3, 5], notes: 'action types (strings)' },
    { range: [7, 9], notes: 'actual actions (functions)' },
    { range: [11, 15], notes: 'our redux handlers (type -> action)' },
    { range: [17, 21], notes: 'our _ONLY_ reducer 😎' },
    { range: [23, 27], notes: 'it works! 👏' },
  ]}
/>
